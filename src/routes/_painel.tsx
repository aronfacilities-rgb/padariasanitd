...
const MOBILE_KEYS = ["/comandas", "/pdv", "/produtos", "/ponto"];
    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-6">
        <div className="panel max-w-md p-8 text-center">
          ...
          <h1 className="mt-4 font-display text-xl">Acesso aguardando liberação</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Sua conta foi criada, mas ainda não possui permissões. Peça à administração para
            liberar seu perfil de acesso.
          </p>
      ...
      <header className="sticky top-0 z-20 flex items-center justify-between gap-3 border-b border-border bg-card/95 px-4 py-3 backdrop-blur lg:hidden">
        ...
        <Sheet open={menuOpen} onOpenChange={setMenuOpen}>
          ...
          <SheetContent side="right" className="w-72 bg-sidebar p-4">
            <SheetTitle className="px-2 font-display text-base text-sidebar-foreground">
              Menu
            </SheetTitle>
