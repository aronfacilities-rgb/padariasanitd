...
function ProdutosPage() {
  ...
  return <><PageHeader title="Produtos" description="Cadastro, preços, estoque e códigos dos produtos." actions={isOperator ? <Button className="h-11" onClick={() => { setEditando(null); setAberto(true); }}><Plus className="size-4" /> Novo produto</Button> : null} />
